...
internal static class SqlServerColumnTypes
{
    public static byte TdsType(this ColumnType t) => t switch
    {
        ...
        ColumnType.Nvarchar => TdsColumnTypes.TypeNVarChar,
        ...
        ColumnType.Money => TdsColumnTypes.TypeMoney,
        ColumnType.SmallMoney => TdsColumnTypes.TypeSmallMoney,
        ColumnType.Bit => TdsColumnTypes.TypeBit,
        ColumnType.Guid => TdsColumnTypes.TypeUniqueIdentifier,
